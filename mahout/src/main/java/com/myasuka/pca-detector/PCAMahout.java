...
public class PCAMahout {
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.err.println("USAGE: PCAMahout <training data set>  <suspected ratio>");
            System.exit(-1);
        }
        ...
        // step 2: execute SVD on the sequence file matrix
...
//            movieIdSet.add(movieId);
        ...
        BufferedWriter user2RowIndexWriter = new BufferedWriter(new OutputStreamWriter(fs.create(new Path(mapPath + "/user2RowIndex"))));
        BufferedWriter movie2ColIndexWriter = new BufferedWriter(new OutputStreamWriter(fs.create(new Path(mapPath + "/movie2ColIndex"))));
        BufferedWriter movieAverageRateWriter = new BufferedWriter(new OutputStreamWriter(fs.create(new Path(mapPath + "/movieAvgRates"))));
