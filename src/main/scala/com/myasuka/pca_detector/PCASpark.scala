...
object PCASpark {
  def main(args: Array[String]) {
    ...
    //    val path = "hdfs://srgsi-80:8020/data/cloud_compete/train-and-test/badman_train.dat"
    //    val path = "hdfs://srgsi-80:8020/data/cloud_compete/train-and-test/badman_train.dat2"
    val input = args(0)
    //    val output = s"/home/dm/workspace/tangyun/cloud-compute/spark-results/ml10m_rank_:q${rank}_pc_${pc}.csv"
    val output = args(1)
