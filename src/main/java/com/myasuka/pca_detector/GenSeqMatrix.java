...
/**
 * With given user-movie file, generate sequence file in hdfs
 */
...
//            mo.close();
    ...
    public static class GenSeqReducer extends Reducer<Text, Text, IntWritable, VectorWritable> {
        ...
        @Override
        protected void setup(Context context) throws IOException, InterruptedException {
            // number of movies in ml-10m data is 10681. For ml-100k data, the number is 1682
            movieLen = context.getConfiguration().getInt("movies", 1682);
        }
